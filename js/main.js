...
const modalClose = document.querySelector('modal-cloce');
const view_All = document.querySelectorAll('.view-all')
...
// goods  / Получение данных с сервера
